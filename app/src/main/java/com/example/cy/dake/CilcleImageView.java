...
public class CilcleImageView extends android.support.v7.widget.AppCompatImageView {

    private Paint paint = new Paint();



    public  CilcleImageView(Context context) {
    ...
    public  CilcleImageView(Context context, AttributeSet attrs) {
    ...
    public  CilcleImageView(Context context, AttributeSet attrs, int defStyle) {
